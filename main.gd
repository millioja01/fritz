...
func get_y_velocity(time: float) -> float:
	...
	return ((1.6 * k + gravity) * pow(e, time) - gravity) / k
...
func _on_drag_edit_text_submitted(new_text: String) -> void:
	if new_text.to_float() == 0.0:
		return
...
func _on_cross_section_area_text_submitted(new_text: String) -> void:
	if new_text.to_float() == 0.0:
		return
...
func _on_object_edit_text_submitted(new_text: String) -> void:
	if new_text.to_float() == 0.0:
		return
...
func _on_dog_edit_text_submitted(new_text: String) -> void:
	if new_text.to_float() == 0.0:
		return
...
func _on_tracking_edit_text_submitted(new_text: String) -> void:
	if new_text.to_float() == 0.0:
		return
